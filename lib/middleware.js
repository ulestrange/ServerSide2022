...
const getNewsData = () => [
  ...
  const loggingMiddleware2 = (req, res, next) => {
    console.log(req.method + " Request made with second logging " +  req.url);
    next()
  }


module.exports = { newsMiddleware: newsMiddleware, flashMiddleware: flashMiddleware,
   loggingMiddleware : loggingMiddleware, loggingMiddleware2: loggingMiddleware2}
